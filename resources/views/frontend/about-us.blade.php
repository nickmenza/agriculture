...
<div style="background-color:white">
    <div class="container pt-5 pb-5">
        <div class="mb-4">
            <label class="font-bold">ปัจจุบันบริษัท อาร์ดี เกษตรพัฒนา จำกัด</label> มีธุรกิจแปลงเพาะกล้าและสวนปาล์มน้ำมันทั้งในภาคใต้และภาคตะวันออก โดยมีแปลงเพาะกล้าจำนวน 11 แห่ง คือ 3 
            แห่งในจังหวัดชุมพร (ศูนย์ท่าแซะ ศูนย์สวี และศูนย์ปะทิว) 1 แห่ง ในจังหวัดสุราษฎร์ธานี (ศูนย์ท่าชนะ) 1 แห่ง ในจังหวัดสงขลา (ศูนย์รัตภูมิ) 1 แห่ง ในจังหวัดสตูล 
            (ศูนย์สตูล) 1 แห่ง ในจังหวัดพัทลุง (ศูนย์พัทลุง) 2 แห่ง ในจังหวัดนครศรีธรรมราช (ศูนย์บ่อล้อ ศูนย์ทุ่งสง ) และ 2 แห่ง ในภาคกลางและตะวันออก 
            (ศูนย์นครนายก ศูนย์ปราจีนบุรี)  อาร์ดี เกษตรพัฒนา มุ่งมั่นสร้างสรรค์งานบริการ และให้ความรู้เกษตรเพื่อยกระดับอุตสาหกรรมปาล์มน้ำมันไทย
        </div>
        <div>
